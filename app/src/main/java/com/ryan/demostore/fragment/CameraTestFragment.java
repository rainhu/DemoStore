...
public class CameraTestFragment extends Fragment {
    ...
    public static String TAG = "CameraTestFragment";
    ...
    private ImageReader.OnImageAvailableListener mImageAvailableListener = new ImageReader.OnImageAvailableListener() {
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            if(null != bitmap){
                ...
                Toast.makeText(getContext(), "获取照片失败！", Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        if (mNextVideoAbsolutePath == null || mNextVideoAbsolutePath.isEmpty()) {
            mNextVideoAbsolutePath = getVideoFilePath(getContext());
        }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mCamaraManager = (CameraManager) getContext().getSystemService(Context.CAMERA_SERVICE);
    ...
    public void initCameraOutput(){
        ...
        try {
            ...
            mVideoSize = chooseVideoSize(map.getOutputSizes(getClass()));
    ...
    private void requestCameraPermission(String [] permissions){
        ...
        if(shouldShowRequestPermissionRationale(permissions)){
            ...
            Toast.makeText(getContext(), "请勾选Camera权限", Toast.LENGTH_LONG).show();
        } else {
    ...
    private CameraDevice.StateCallback deviceStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(CameraDevice camera, int error) {
            mCameraOpenCloseLock.release();
            mCameraDevice = null;
            Toast.makeText(getContext(), "开启摄像头失败", Toast.LENGTH_SHORT).show();
        }
